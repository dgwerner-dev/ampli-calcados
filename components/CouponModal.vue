    ...
    >
      ...
      >
          ...
          <form @submit.prevent="saveCoupon" class="space-y-8">
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="flex space-x-3">
                    ...
                    <button
                      type="button"
                      @click="generateCode"
                      class="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                  ...
                  <p class="mt-2 text-xs text-gray-500">
                    O código do cupom é o que você dará para o seu cliente preencher no carrinho
                    de compras.
                  </p>
                </div>
              </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <div class="ml-3 flex-1">
                      <span class="text-sm font-medium text-gray-900 group-hover:text-coral-700">Percentual</span>
                  ...
                  >
                    ...
                    />
                    <div class="ml-3 flex-1">
                      <span class="text-sm font-medium text-gray-900 group-hover:text-coral-700">Valor fixo</span>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label for="usagePerCustomer" class="block text-sm font-medium text-gray-700 mb-2">
                    Quantidade de uso por cliente
                  </label>
                  <input
                    id="usagePerCustomer"
                  ...
                  <div class="space-y-3">
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom para todos os produtos</span>
                    </label>
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        v-model="form.productRestriction"
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom em um ou mais produtos específicos</span>
                    </label>
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        v-model="form.productRestriction"
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom em uma ou mais categorias específicas</span>
                    </label>
                  </div>
                </div>
                  ...
                  <div class="space-y-3">
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom para todos os clientes</span>
                    </label>
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        v-model="form.customerRestriction"
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom para um cliente específico</span>
                    </label>
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
                        v-model="form.customerRestriction"
                        ...
                        class="h-4 w-4 text-coral-soft focus:ring-coral-soft border-gray-300"
                      />
                      <span class="ml-3 text-sm text-gray-700">Aplicar cupom para um grupo de cliente específico</span>
                    </label>
                  </div>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <div class="space-y-3">
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      ...
                      />
                      <span class="ml-3 text-sm text-gray-700">Limitar cupom por valor mínimo do carrinho</span>
                    </label>
                    <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <input
        ...
        <div class="bg-white px-6 py-4 border-t border-gray-100">
          <div class="flex flex-col sm:flex-row-reverse sm:space-x-3 sm:space-x-reverse space-y-3 sm:space-y-0">
            <button
              type="button"
              @click="saveCoupon"
              :disabled="saving"
