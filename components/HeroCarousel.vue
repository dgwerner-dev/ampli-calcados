  ...
  <ClientOnly>
    <section class="pt-32 pb-16 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        <div class="relative">
          <!-- Loading State - Skeleton Loading Otimizado -->
          <div v-if="loading" class="relative overflow-hidden rounded-lg shadow-lg">
          ...
          <div v-else-if="slides.length > 0" class="relative overflow-hidden rounded-lg shadow-lg">
            ...
            >
              <div v-for="(slide, index) in slides" :key="index" class="w-full flex-shrink-0">
                <div class="flex flex-col lg:flex-row">
                  <!-- Product Image com Lazy Loading -->
                  <div class="lg:w-1/2 p-8 lg:p-12">
...
<style scoped>
.carousel-dot {
  @apply w-3 h-3 rounded-full bg-white/50 transition-all duration-300 hover:bg-white/75;
}
...
.carousel-feature-card {
  @apply flex items-center space-x-2 px-3 py-2 rounded-full text-xs font-medium;
}
