      ...
      <form @submit.prevent="updateProfile" class="p-6 space-y-6">
        ...
        <div class="flex items-center space-x-6">
          <div class="flex-shrink-0">
            <div class="relative">
              <div class="w-24 h-24 bg-gradient-to-br from-coral-soft to-coral-dark rounded-full flex items-center justify-center text-white text-2xl font-bold">
                {{ userInitials }}
              </div>
              <button
                type="button"
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-500 mt-1">Clique no ícone da câmera para alterar sua foto</p>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
              ...
              <div class="flex space-x-2">
                ...
                >
                  <svg v-if="searchingCep" class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
...
const loadUserData = async () => {
  ...
  try {
    ...
    form.value.dateOfBirth = profileData.dateOfBirth ? new Date(profileData.dateOfBirth).toISOString().split('T')[0] : '';
