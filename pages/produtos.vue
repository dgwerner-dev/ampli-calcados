      ...
      <div v-else class="text-center py-16">
        <div class="bg-white rounded-lg p-8 max-w-md mx-auto">
          ...
          <h3 class="text-lg font-medium text-gray-900 mb-2">
            {{ selectedSize ? `Nenhum produto encontrado no tamanho ${selectedSize}` : 'Nenhum produto encontrado' }}
          </h3>
          <p class="text-gray-600 mb-6">
            {{ selectedSize ? 'Tente selecionar outro tamanho ou explore nossa coleção completa.' : 'Tente ajustar os filtros ou explore nossa coleção.' }}
          </p>
          <button
            @click="clearFilter"
