    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div v-if="isEmpty" class="text-center py-12">
        ...
        <div class="mt-6">
          <NuxtLink
            to="/"
            class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-coral-soft hover:bg-coral-dark"
          >
            Continuar Comprando
          </NuxtLink>
        </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
          <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-3">
              ...
              <NuxtLink
                to="/checkout"
                class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-coral-soft hover:bg-coral-dark"
              >
                Comprar Agora
              </NuxtLink>
            </div>
      ...
      <div class="mt-8">
        ...
        <div
          v-else-if="recommendedProducts.length > 0"
